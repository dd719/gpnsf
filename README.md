...
The specific model discription and detailed derivation of the loss function are included in [model_discription.pdf](https://github.com/dd719/gpnsf/blob/main/model_discription.pdf).
# Model architecture
